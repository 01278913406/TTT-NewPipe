...
import static org.chicha.ttt.player.helper.PlayerHelper.isPlaybackResumeEnabled;
import static org.chicha.ttt.player.helper.PlayerHelper.nextRepeatMode;
import static org.chicha.ttt.player.helper.PlayerHelper.retrievePlaybackParametersFromPrefs;
import static org.chicha.ttt.player.helper.PlayerHelper.retrieveSeekDurationFromPreferences;
import static org.chicha.ttt.player.helper.PlayerHelper.savePlaybackParametersToPrefs;
import static org.chicha.ttt.player.notification.NotificationConstants.ACTION_CLOSE;
import static org.chicha.ttt.player.notification.NotificationConstants.ACTION_FAST_FORWARD;
import static org.chicha.ttt.player.notification.NotificationConstants.ACTION_FAST_REWIND;
import static org.chicha.ttt.player.notification.NotificationConstants.ACTION_PLAY_NEXT;
import static org.chicha.ttt.player.notification.NotificationConstants.ACTION_PLAY_PAUSE;
import static org.chicha.ttt.player.notification.NotificationConstants.ACTION_PLAY_PREVIOUS;
import static org.chicha.ttt.player.notification.NotificationConstants.ACTION_RECREATE_NOTIFICATION;
import static org.chicha.ttt.player.notification.NotificationConstants.ACTION_REPEAT;
import static org.chicha.ttt.player.notification.NotificationConstants.ACTION_SHUFFLE;
import static org.chicha.ttt.util.ListHelper.getPopupResolutionIndex;
import static org.chicha.ttt.util.ListHelper.getResolutionIndex;
import static org.chicha.ttt.util.Localization.assureCorrectAppLanguage;
...
import org.chicha.ttt.databinding.PlayerBinding;
...
import org.chicha.ttt.player.event.PlayerEventListener;
import org.chicha.ttt.player.event.PlayerServiceEventListener;
import org.chicha.ttt.player.helper.AudioReactor;
import org.chicha.ttt.player.helper.LoadController;
import org.chicha.ttt.player.helper.PlayerDataSource;
import org.chicha.ttt.player.helper.PlayerHelper;
import org.chicha.ttt.player.mediaitem.MediaItemTag;
import org.chicha.ttt.player.mediasession.MediaSessionPlayerUi;
import org.chicha.ttt.player.notification.NotificationPlayerUi;
import org.chicha.ttt.player.playback.MediaSourceManager;
import org.chicha.ttt.player.playback.PlaybackListener;
import org.chicha.ttt.player.playqueue.PlayQueue;
import org.chicha.ttt.player.playqueue.PlayQueueItem;
import org.chicha.ttt.player.resolver.AudioPlaybackResolver;
import org.chicha.ttt.player.resolver.VideoPlaybackResolver;
import org.chicha.ttt.player.resolver.VideoPlaybackResolver.SourceType;
import org.chicha.ttt.player.ui.MainPlayerUi;
import org.chicha.ttt.player.ui.PlayerUi;
import org.chicha.ttt.player.ui.PlayerUiList;
import org.chicha.ttt.player.ui.PopupPlayerUi;
import org.chicha.ttt.player.ui.VideoPlayerUi;
import org.chicha.ttt.util.DeviceUtils;
import org.chicha.ttt.util.ListHelper;
import org.chicha.ttt.util.NavigationHelper;
import org.chicha.ttt.util.PicassoHelper;
import org.chicha.ttt.util.SerializedCache;
import org.chicha.ttt.util.StreamTypeUtil;
