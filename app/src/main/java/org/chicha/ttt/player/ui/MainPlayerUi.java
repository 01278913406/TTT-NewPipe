package org.chicha.ttt.player.ui;

import static android.view.ViewGroup.LayoutParams.MATCH_PARENT;
import static org.chicha.ttt.MainActivity.DEBUG;
import static org.chicha.ttt.QueueItemMenuUtil.openPopupMenu;
import static org.chicha.ttt.ktx.ViewUtils.animate;
import static org.chicha.ttt.player.Player.STATE_COMPLETED;
import static org.chicha.ttt.player.Player.STATE_PAUSED;
import static org.chicha.ttt.player.helper.PlayerHelper.MinimizeMode.MINIMIZE_ON_EXIT_MODE_BACKGROUND;
import static org.chicha.ttt.player.helper.PlayerHelper.MinimizeMode.MINIMIZE_ON_EXIT_MODE_NONE;
import static org.chicha.ttt.player.helper.PlayerHelper.MinimizeMode.MINIMIZE_ON_EXIT_MODE_POPUP;
import static org.chicha.ttt.player.helper.PlayerHelper.getMinimizeOnExitAction;
import static org.chicha.ttt.player.helper.PlayerHelper.getTimeString;
import static org.chicha.ttt.player.helper.PlayerHelper.globalScreenOrientationLocked;
...
import org.chicha.ttt.fragments.OnScrollBelowItemsListener;
import org.chicha.ttt.fragments.detail.VideoDetailFragment;
import org.chicha.ttt.info_list.StreamSegmentAdapter;
import org.chicha.ttt.ktx.AnimationType;
import org.chicha.ttt.local.dialog.PlaylistDialog;
import org.chicha.ttt.player.Player;
import org.chicha.ttt.player.event.PlayerServiceEventListener;
import org.chicha.ttt.player.gesture.BasePlayerGestureListener;
import org.chicha.ttt.player.gesture.MainPlayerGestureListener;
import org.chicha.ttt.player.helper.PlaybackParameterDialog;
import org.chicha.ttt.player.helper.PlayerHelper;
import org.chicha.ttt.player.playqueue.PlayQueue;
import org.chicha.ttt.player.playqueue.PlayQueueAdapter;
import org.chicha.ttt.player.playqueue.PlayQueueItem;
import org.chicha.ttt.player.playqueue.PlayQueueItemBuilder;
import org.chicha.ttt.player.playqueue.PlayQueueItemHolder;
import org.chicha.ttt.player.playqueue.PlayQueueItemTouchCallback;
import org.chicha.ttt.util.DeviceUtils;
import org.chicha.ttt.util.NavigationHelper;
import org.chicha.ttt.util.external_communication.KoreUtils;
