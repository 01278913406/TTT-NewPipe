...
import static org.chicha.ttt.player.Player.RENDERER_UNAVAILABLE;
import static org.chicha.ttt.player.Player.STATE_BUFFERING;
import static org.chicha.ttt.player.Player.STATE_COMPLETED;
import static org.chicha.ttt.player.Player.STATE_PAUSED;
import static org.chicha.ttt.player.Player.STATE_PAUSED_SEEK;
import static org.chicha.ttt.player.Player.STATE_PLAYING;
import static org.chicha.ttt.player.helper.PlayerHelper.formatSpeed;
import static org.chicha.ttt.player.helper.PlayerHelper.getTimeString;
import static org.chicha.ttt.player.helper.PlayerHelper.nextResizeModeAndSaveToPrefs;
...
import org.chicha.ttt.player.gesture.DisplayPortion;
import org.chicha.ttt.player.helper.PlayerHelper;
import org.chicha.ttt.player.mediaitem.MediaItemTag;
import org.chicha.ttt.player.playback.SurfaceHolderCallback;
import org.chicha.ttt.player.playqueue.PlayQueue;
import org.chicha.ttt.player.playqueue.PlayQueueItem;
import org.chicha.ttt.player.seekbarpreview.SeekbarPreviewThumbnailHelper;
import org.chicha.ttt.player.seekbarpreview.SeekbarPreviewThumbnailHolder;
...
import org.chicha.ttt.views.player.PlayerFastSeekOverlay;
    ...
    public boolean onKeyDown(final int keyCode) {
        switch (keyCode) {
            ...
            case KeyEvent.KEYCODE_DPAD_CENTER:
                ...
                if (player.getCurrentState() == org.chicha.ttt.player.Player.STATE_BLOCKED) {
                    return true;
                }
