package org.chicha.ttt.player.mediasource;
...
import org.chicha.ttt.player.mediaitem.ExceptionTag;
...
public class FailedMediaSource extends BaseMediaSource implements ManagedMediaSource {
     ...
     * such as {@link org.chicha.ttt.extractor.exceptions.ExtractionException}.
     *
     ...
     * {@link org.chicha.ttt.extractor.exceptions.ExtractionException ExtractionException}.
     ...
     * {@link org.chicha.ttt.player.Player Player} can react to inside
