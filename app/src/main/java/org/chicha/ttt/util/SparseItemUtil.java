...
public final class SparseItemUtil {
     ...
     * org.chicha.ttt.extractor.feed.FeedExtractor}. FeedExtractors provide a fast and
     * lightweight method to fetch info, but the info might be incomplete (see
     * {@link org.chicha.ttt.local.feed.service.FeedLoadService} for more details).
     *
     ...
     *                 org.chicha.ttt.extractor.stream.StreamInfo}
     */
     ...
     * org.chicha.ttt.extractor.feed.FeedExtractor}). A toast is shown if loading details is
     * required.
     *
     * @param context     Android context
     ...
     *                    org.chicha.ttt.extractor.stream.StreamInfo} corresponding to the item
     */
