package org.chicha.ttt.database.stream.model;
...
import static org.chicha.ttt.database.stream.model.StreamStateEntity.JOIN_STREAM_ID;
...
public class StreamStateEntity {
     ...
     * (60000ms = 60s).
     * @see #isFinished(long)
     * @see org.chicha.ttt.database.feed.dao.FeedDAO#getLiveOrNotPlayedStreams()
     * @see org.chicha.ttt.database.feed.dao.FeedDAO#getLiveOrNotPlayedStreamsForGroup(long)
     */
