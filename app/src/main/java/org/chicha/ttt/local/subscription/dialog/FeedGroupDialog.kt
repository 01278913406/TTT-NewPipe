package org.chicha.ttt.local.subscription.dialog
...
import org.chicha.ttt.databinding.DialogFeedGroupCreateBinding
import org.chicha.ttt.databinding.ToolbarSearchLayoutBinding
import org.chicha.ttt.fragments.BackPressable
import org.chicha.ttt.local.subscription.FeedGroupIcon
import org.chicha.ttt.local.subscription.dialog.FeedGroupDialog.ScreenState.DeleteScreen
import org.chicha.ttt.local.subscription.dialog.FeedGroupDialog.ScreenState.IconPickerScreen
import org.chicha.ttt.local.subscription.dialog.FeedGroupDialog.ScreenState.InitialScreen
import org.chicha.ttt.local.subscription.dialog.FeedGroupDialog.ScreenState.SubscriptionsPickerScreen
import org.chicha.ttt.local.subscription.dialog.FeedGroupDialogViewModel.DialogEvent.ProcessingEvent
import org.chicha.ttt.local.subscription.dialog.FeedGroupDialogViewModel.DialogEvent.SuccessEvent
import org.chicha.ttt.local.subscription.item.EmptyPlaceholderItem
import org.chicha.ttt.local.subscription.item.PickerIconItem
import org.chicha.ttt.local.subscription.item.PickerSubscriptionItem
